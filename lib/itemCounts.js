...
let bookFinder = require('./findBook');

let text = require('./readFile');

let bookLength = require('./length.js');
...
if (require.main === module) {
  ...
  console.log(itemCounts(stringToCharacters(sanitize(bookLength(text(bookFinder(book)))))));
}
